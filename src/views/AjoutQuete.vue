...
<template>
  ...
  <div class="py-20">
    <div class="px-10">
      <h5 class="font-league-gothic text-2xl text-violet">
        Liste des quetes - Liste synchronisée
      </h5>
    </div>
    <form class="mb-3 px-10">
      <h3 class="font-league-gothic text-xl text-fushia px-10">
        Nouveaux quetes
      </h3>
      <div class="input-group px-10">
        ...
        >
          <img
            src="../../public/icon/add.svg"
            class="w-7"
            alt="icone d'ajout d'une quete dans la liste"
          />
        </button>
      </div>
    </form>
  ...
  <button
    class="border-black bottom-2 py-20"
    type="button"
    @click="updateQuetes(quetes)"
    title="Création"
  >
    Modifier la quête
  </button>
